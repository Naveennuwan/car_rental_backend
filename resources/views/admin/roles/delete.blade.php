    ...
    <div class="toolbar">
        <div class="row col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-5 col-md-6">
                <h6 class="text-muted">@lang('general.nav.user_managment') / @lang('rolesLng.form_title') / @lang('general.common.delete')</h6>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form method="POST" action="{{ route('admin.roles.destroy', $dataObj->id) }}" name="deleteForm"
                            id="deleteForm">
                            @csrf
                            @method('delete')
                            <div class="card">
