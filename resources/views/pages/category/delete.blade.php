    ...
    <div class="toolbar">
        <div class="row col-12 col-sm-12 col-md-12">
            <div class="col-12 col-sm-5 col-md-6">
                <h6 class="text-muted">@lang('general.nav.master_control') / @lang('categoryLng.form_title') / @lang('general.common.delete')</h6>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form method="POST" action="{{ route('category.destroy', $categoryObj->id) }}" name="deleteForm"
                            id="deleteForm">
                            @csrf
                            @method('delete')
                            <div class="card">
                                <div class="card-body">
                                    @include('pages.category.body')
                                </div>
                            </div>
                        </form>
                        <div class="">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center mt-3 mb-3">
                                            <h6 class="modal-title" id="deleteModalTitle">Do you want to delete customer information?</h6>
                                        </div>
